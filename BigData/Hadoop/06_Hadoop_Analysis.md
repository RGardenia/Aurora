...
![image-20230227144538151](images/image-20230227144538151.png)

1）需求：

​	模拟 RPC 的客户端、服务端、通信协议三者如何工作的

![image-20230227144559851](images/image-20230227144559851.png)

2）代码编写：

（1）在 HDFSClient 项目基础上创建包名 com.gardenia.rpc

（2）创建 RPC 协议

```java
package com.gardenia.rpc;
...
![image-20230227145005241](images/image-20230227145005241.png)
...
1）ctrl + n 全局查找 namenode，进入NameNode.java
...
![image-20230227150343753](images/image-20230227150343753.png)

![image-20230227150403584](images/image-20230227150403584.png)
...
![image-20230227151506976](images/image-20230227151506976.png)
...
2）Ctrl + h查找 create 实现类，点击 NameNodeRpcServer，在 NameNodeRpcServer.java 中搜索 `create`
...
1）点击 `newStreamForCreate` 方法中的`out.start()` ，进入DFSOutputStream.java
...
点击 DataStreamer，进入DataStreamer.java
...
Ctrl + n 全局查找 `DataXceiverServer.java` ，在该类中查找run方法
...
Ctrl + n 全局查找 DataStreamer ，搜索run方法
...
​	点击 MRAppMaster.java 中的 `initAndStartAppMaster`
​		方法中的 `appMaster.start();` 
...
![image-20230227163717648](images/image-20230227163717648.png)
...
![image-20230227163940253](images/image-20230227163940253.png)
...
tar -zxvf hadoop-3.3.1-src.tar.gz -C  /opt/module/hadoop_source/
...
```bash
pwd
/opt/module/hadoop_source/hadoop-3.3.1-src
...
![image-20230227165226204](images/image-20230227165226204.png)

**2）成功的 64位 hadoop 包在 /opt/module/hadoop_source/hadoop-3.3.1-src/hadoop-dist/target 下**

```bash
pwd
/opt/module/hadoop_source/hadoop-3.3.1-src/hadoop-dist/target
```
