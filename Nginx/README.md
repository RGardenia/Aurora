...
<img src="images/image-20220602155809354.png" alt="image-20220602155809354" style="zoom:50%;" />
...
![image-20220602160023569](images/image-20220602160023569.png)
...
- `http` [配置代理](http://mp.weixin.qq.com/s?__biz=MzU2MTI4MjI0MQ==&mid=2247504869&idx=2&sn=d6fa8bd9dbc770f429e005e1287b85e7&chksm=fc79be4bcb0e375d25625bab18a130aedc539b3e2293827930ab6fa8509363749101f939f522&scene=21#wechat_redirect)，缓存，日志定义等绝大多数功能和第三方模块的配置；
...
![image-20220602160124823](images/image-20220602160124823.png)
...
![image-20220602160320077](images/image-20220602160320077.png)
...
是否打开[负载均衡](http://mp.weixin.qq.com/s?__biz=MzU2MTI4MjI0MQ==&mid=2247511112&idx=2&sn=0656e529fcb31d704762d72e0e0a2b97&chksm=fc79c1e6cb0e48f01e1e37c7a01781685fb381c705f120e43a3aaefa3a24da5f70748016646b&scene=21#wechat_redirect)互斥锁。
...
它也是指定[静态资源](http://mp.weixin.qq.com/s?__biz=MzI4Njc5NjM1NQ==&mid=2247487426&idx=1&sn=ef1f0ec452bcf86ad6e35dd237532aba&chksm=ebd630eedca1b9f8ea865719da21d759cd2122d4e9f699c05dd0fd6fb4e83593060d0d40556b&scene=21#wechat_redirect)目录位置，它只能写在 `location` 中。
...
![image-20220602160431595](images/image-20220602160431595.png)
...
![image-20220602160520564](images/image-20220602160520564.png)
...
![image-20220602160559764](images/image-20220602160559764.png)
...
![image-20220602160641564](images/image-20220602160641564.png)
...
![image-20220602160818873](images/image-20220602160818873.png)
...
单个[长连接](http://mp.weixin.qq.com/s?__biz=MzU2MTI4MjI0MQ==&mid=2247487656&idx=3&sn=15b14ccea9c09bfffee4f88ef418a129&chksm=fc7a7d06cb0df410ebe8047012b4f02683b1fabe3cce63d264ed5fa96f5e6972bbe7715c9e68&scene=21#wechat_redirect)可以处理的最多 `HTTP` 请求个数。
...
![image-20220602160849074](images/image-20220602160849074.png)
...
![image-20220602160912680](images/image-20220602160912680.png)

启用 `gzip` 同时需要客户端和服务端的支持，如果客户端支持 `gzip` 的解析，那么只要服务端能够返回 `gzip` 的文件就可以启用 `gzip` 了,我们可以通过 `Nginx` 的配置来让服务端支持 `gzip` 。下面的 `respone` 中 `content-encoding:gzip` ，指服务端开启了 `gzip` 的压缩方式。

![image-20220602160922502](images/image-20220602160922502.png)
...
![image-20220602161015037](images/image-20220602161015037.png)
...
![image-20220602161220724](images/image-20220602161220724.png)
